...
namespace BookStoreKAP.Data
{
	public class BookStoreKAPDBContext : IdentityDbContext<User, Role, Guid, UserClaim, UserRole, UserLogin, RoleClaim, UserToken>
	{
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<OrderDetail>().Property(e => e.ID).HasDefaultValueSql("NEWID()");
			builder.Entity<OrderDetail>().Property(e => e.CreatedAt).HasDefaultValueSql("GETDATE()");
			builder.Entity<OrderDetail>().Property(e => e.UpdatedAt).HasDefaultValueSql("GETDATE()");
