...
namespace BookStoreKAP.Migrations
{
    ...
    [Migration("20250505020405_AddPromotionBooksTable")]
    partial class AddPromotionBooksTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreKAP.Models.Entities.Cart", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("BookStoreKAP.Models.Entities.CartItem", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("BookStoreKAP.Models.Entities.PromotionBook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookStoreKAP.Models.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("BookStoreKAP.Models.Entities.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("BookStoreKAP.Models.Entities.PromotionBook", b =>
                {
                    ...
                    b.HasOne("BookStoreKAP.Models.Entities.Promotion", "Promotion")
